#!/usr/bin/env python3
"""Run ONE problem of manager_coercion_benchmark through TrustedRouter and emit a reproducibility bundle.
...
TASK = "inspect_evals/manager_coercion"
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Run one manager_coercion_benchmark problem via TrustedRouter")
