...
`eval-manager_coercion_benchmark` packages an evaluation from **inspect_evals**.

- **Upstream:** https://github.com/UKGovernmentBEIS/inspect_evals (`register/manager_coercion_benchmark`)
